		...
		<view class="cu-card dynamic " :class="isCard?'no-card':''">
			<view class="cu-item shadow">
				...
				<view class="text-content new-text-black" style="padding:0 24rpx;" >
					<text class="new-text-red" style="padding-right:24rpx;">英雄联盟</text> 折磨生出苦难，苦难又会加剧折磨，凡间这无穷的循环，将有我来终结！
				</view>
		...
		<view class="cu-card dynamic new-margin-top" :class="isCard?'no-card':''">
			<view class="cu-item shadow">
				...
				<view class="text-content"  style="padding:0 24upx;" >
					<view class="audio-content text-white flex">
						<view class="flex-sub" v-if="audioPaused" @tap='audioStart'>
							<text class="cuIcon-playfill padding-left"></text>
						</view>
						<view class="flex-sub" v-else @tap='audioStop'>
							<text class="cuIcon-stop padding-left"></text>
